...
# NOTE: This model is based on PowNet v1.3, which is no longer developed. If you are interested in running an instance of PowNet for the Thai power system, please check the latest release of PowNet (v2.0), which includes input data for this case study.
